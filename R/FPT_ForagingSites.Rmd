...
library(pacman)
<<<<<<< HEAD
p_load("momentuHMM", "lubridate", "data.table", "zoo", "move", "dplyr", "adehabitatLT", mixtools)
=======
p_load("momentuHMM", "lubridate", "data.table", "zoo", "move", "dplyr", "adehabitatLT", ggplot2, latticeExtra)
>>>>>>> 67431106ba6fcd2ddcdec0ebae7e6c9012b2f3df
...
#   b <- Bats[Bats$id == IDs[i],]
#   # plot(b$x, b$y, col = b$FPT01+1,
#   #      asp = 1)
#   
#   p <- ggplot(b, aes(x, y, col = FPT))+geom_path()+
